...
Orchestrator for the Myapp project. This is a **routing table** (not an active agent) — Claude's main context reads this skill to decide which agent to dispatch for a given task.
