...
### v1.2 Features (from competitive research + roadmap)

| # | Feature | Priority | Effort |
|---|---------|----------|--------|
| V12-01 | `/buddyx-forge:upgrade` command — preserve memory, merge hooks, show diff | High | 4-6 hours |
| V12-02 | `/buddyx-forge:export-config` — shareable team config | High | 2-3 hours |
| V12-03 | Atomic generation (temp dir + rollback) | High | 2-3 hours |
| V12-04 | Split generate.py into modules | Medium | 4-6 hours |
...
| V12-09 | `--dry-run` for dream command | Low | 30 min |
| V12-10 | Use tempfile for config instead of predictable /tmp path | Low | 10 min |

### Adoption / Marketing (from competitive research)

| # | Action | Priority |
|---|--------|----------|
| MK-01 | Add GitHub description + topics | Today |
| MK-02 | Create GitHub release tag v1.1.0 | Today |
| MK-03 | Record GIF/video of setup flow | This week |
| MK-04 | Write "What is multi-agent?" README section | This week |
| MK-05 | Add use-case stories to README | This week |
| MK-06 | Write blog post / dev.to article | This month |
| MK-07 | Post in Claude Code community | This month |
| MK-08 | Set up GitHub Actions CI | This month |
| MK-09 | Add GitHub issue templates | This month |
...
**Biggest gaps:** No parallel execution, no auto model routing, audit skill still Laravel-heavy
